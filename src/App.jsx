...
export default function App() {
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      ...
      gsap.from('.project-card', { scrollTrigger: { trigger: '.projects-section', start: 'top 65%' }, y: 50, opacity: 0, duration: 0.7, stagger: 0.12, ease: 'power2.out' });
      gsap.from('.venture-card', { scrollTrigger: { trigger: '.ventures-section', start: 'top 65%' }, y: 50, opacity: 0, duration: 0.7, stagger: 0.15, ease: 'power2.out' });
      gsap.from('.cert-card', { scrollTrigger: { trigger: '.certs-section', start: 'top 65%' }, y: 50, opacity: 0, duration: 0.7, stagger: 0.12, ease: 'power2.out' });
      gsap.from('.philosophy-quote', { scrollTrigger: { trigger: '.philosophy-section', start: 'top 70%' }, y: 40, opacity: 0, duration: 1, ease: 'power2.out' });
    });
