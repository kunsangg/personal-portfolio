  ...
  return (
    <section id="goal" className="goal-section" ref={sectionRef}>
      <div className="goal-heading-block">
        <div className="goal-word" data-delay="0">My</div>
        <div className="goal-word" data-delay="150">Singular</div>
        <div className="goal-word accent-word" data-delay="300">Impact</div>
        ...
        <div className="goal-sub">
          ...
          <span className="goal-sub-text">Build things that matter — every pixel, every line, every frame.</span>
        </div>
      </div>
    </section>
  );
