      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '32px', marginTop: '40px' }} className="max-md:grid-cols-2 max-sm:grid-cols-1">
          <div style={{ padding: '32px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '4px' }}>
            <div style={{ fontFamily: 'var(--f)', fontWeight: 700, fontSize: '2.8rem', lineHeight: 1, color: 'var(--accent)' }}>40+</div>
          ...
          <div style={{ padding: '32px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '4px' }}>
            <div style={{ fontFamily: 'var(--f)', fontWeight: 700, fontSize: '2.8rem', lineHeight: 1 }}>5</div>
          ...
          <div style={{ padding: '32px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '4px' }}>
            <div style={{ fontFamily: 'var(--f)', fontWeight: 700, fontSize: '2.8rem', lineHeight: 1 }}>12+</div>
          ...
          <div style={{ padding: '32px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '4px' }}>
            <div style={{ fontFamily: 'var(--f)', fontWeight: 700, fontSize: '2.8rem', lineHeight: 1, color: 'var(--accent)' }}>∞</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginTop: '32px' }} className="max-md:grid-cols-1">
          <div style={{ padding: '32px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '4px' }}>
            ...
            <div style={{ fontFamily: 'var(--f)', fontWeight: 600, fontSize: '1.4rem', marginBottom: '4px' }}>Product Design & Dev</div>
          ...
          <div style={{ padding: '32px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '4px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
              ...
              <span style={{ fontFamily: 'var(--f)', fontWeight: 700, color: 'var(--accent)' }}>Figma · After Effects</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontWeight: 500 }}>Dev</span>
              <span style={{ fontFamily: 'var(--f)', fontWeight: 700 }}>React · Tailwind · GSAP</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ marginTop: '60px', paddingTop: '48px', borderTop: '1px solid var(--border)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }} className="max-md:grid-cols-1">
            ...
            <div style={{ padding: '32px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '4px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div style={{ fontFamily: 'var(--f)', fontWeight: 700, fontSize: '1.2rem', lineHeight: 1.2 }}>
